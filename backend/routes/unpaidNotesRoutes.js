...
const {
  ...
  thumbnailUpload,
  pdfUpload
} = require('../controllers/unpaidNotesController');
...
// PDF management routes (Admin only) - Add error handling middleware
...
}, addPDFToNotes);router.put('/:id/pdfs/:pdfId', pdfUpload.single('pdf'), updatePDFInNotes);
